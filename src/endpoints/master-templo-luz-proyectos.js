/**
 * MASTER TEMPLO DE LUZ - Sistema de Proyectos v1
 * 
 * Pantalla de Proyectos en el Templo de Luz con 3 tabs:
 * 1) Proyectos activos
...
export default async function masterTemploLuzProyectosHandler(request, env, ctx) {
  ...
  const contentHtml = `
    <div id="master-proyectos-root" class="p-6">
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-white mb-2">📜 Sistema de Proyectos</h1>
        <p class="text-slate-400">Gestión canónica de proyectos activos, configuración por alumno y clasificaciones.</p>
      </div>
      ...
      <div id="tab-activos" class="tab-content hidden">
        <div class="mb-4 flex items-center justify-between">
          <h2 class="text-xl font-semibold text-white">Proyectos Activos</h2>
  ...
  return renderMasterPage({
    title: 'Sistema de Proyectos - Templo de Luz',
    contentHtml,
    activePath,
