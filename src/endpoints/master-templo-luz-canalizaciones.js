/**
 * MASTER TEMPLO DE LUZ - Canalizaciones
 * 
 * Pantalla de Canalizaciones en el Templo de Luz.
 */

import { renderMasterPage } from '../core/master/layout/master-page-renderer.js';

export default async function masterTemploLuzCanalizacionesHandler(request, env, ctx) {
  const url = new URL(request.url);
  const activePath = url.pathname;
  
  return renderMasterPage({
    title: 'Canalizaciones - Templo de Luz',
    contentHtml: `
