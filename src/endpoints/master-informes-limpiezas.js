      ...
      <div id="master-informes-limpiezas-container" style="padding: 2rem;">
        ...
        <div style="margin-bottom: 2rem; padding: 1.5rem; background: #f8fafc; border-radius: 0.5rem;">
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-bottom: 1rem;">
            <div>
              <label style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #334155;">Estudiante (UUID)</label>
              <input 
                type="text" 
                id="filter-student-uuid" 
                placeholder="UUID del estudiante"
                style="width: 100%; padding: 0.5rem; border: 1px solid #cbd5e1; border-radius: 0.25rem; font-family: monospace;"
              />
            </div>
            <div>
