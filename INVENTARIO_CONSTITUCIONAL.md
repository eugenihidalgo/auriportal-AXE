...
3. docs/CONSTITUTION_VIEW_AUTHORITY_V1.md
   └─ Regla de autoridad de vista (backend como única autoridad)
   
4. docs/ADMIN_UI_CONTRACT_V1.md
   └─ Principios constitucionales UI Admin
   
5. docs/CONTRACT_OF_CONTRACTS.md
